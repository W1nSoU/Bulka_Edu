...
AVAILABLE_ROLES = [
    "ТЗ Старший продавець",
    "ТЗ Продавець-консультант (каса)",
    "ТЗ Продавець відділу гастрономії",
    "ТЗ Продавець відділу кулінарії",
    "ТЗ Продавець (сер. зміна)",
    "ТЗ Продавець-приймальник",
